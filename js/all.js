...
(function() {
  var DrawableObject, Projection, Spiral, Tree, tree,
  ...
  Spiral = (function(_super) {
    var SpiralShadow, factor, getPointByAngle, getdtheta, linelength, linespacing, rate, shapeColor, spiralShadows, thetamax, thetamin;
